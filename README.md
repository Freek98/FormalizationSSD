The goal of today is to organize a private repo with formalizations of the SSD paper to something more presentable. 

In the original repo we had only 3 folders
- the top level folder 
- A folder called "Boole", which was supposed to contain stuff that only relates to countably presented boolean algebras
